 ...
 */
export function renderError(title = 'Error', message = 'Something went wrong', buttonText = 'Back to Home', buttonAction = "window.history.pushState(null, null, '/'); window.dispatchEvent(new PopStateEvent('popstate'))") {
  return `
