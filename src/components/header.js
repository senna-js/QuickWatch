...
export function renderHeader() {
  ...
  return `
    <header class="fixed top-0 left-0 mx-[4rem] bg-transparent transition-all duration-200 rounded-b-2xl z-50 py-3 px-[1rem] pl-[2rem] text-white items-center text-md flex-row justify-between hidden md:flex" style="width: calc(100% - 8rem)">
    ...
    <div class="fixed bottom-[-2px] left-0 w-full flex justify-around items-center py-4 pb-8 z-50 md:hidden bg-zinc-950">
      ...
      <!-- <a href="/anime" class="text-zinc-400 hover:text-white ${isSearch ? 'text-white' : ''} flex flex-col items-center"> ADD BACK WHEN MOBILE ANIME WORKS
