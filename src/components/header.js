...
export function renderHeader() {
  ...
  return `
    <header class="fixed top-0 left-0 mx-[4rem] bg-transparent transition-all duration-200 rounded-b-2xl z-10 py-3 px-[1rem] pl-[2rem] text-white items-center text-md flex flex-row justify-between hidden md:flex" style="width: calc(100% - 8rem)">
