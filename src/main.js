...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (currentPath !== '/' && currentPath !== '/tv' && currentPath !== '/movies' && currentPath !== '/download' && currentPath !== '/search' && currentPath !== '/watchlist' && currentPath !== '/anime' && currentPath.indexOf('embed/aniplay/') === -1) {
