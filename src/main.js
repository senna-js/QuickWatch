...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (currentPath !== '/' && currentPath !== '/tv' && currentPath !== '/movies' && currentPath !== '/download' && currentPath !== '/search' && currentPath !== '/watchlist' && currentPath.indexOf('/anime') === -1 && currentPath.indexOf('embed/aniplay/') === -1) {
