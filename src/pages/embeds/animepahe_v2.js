  ...
  container.innerHTML = `
    <div class="custom-player relative w-full h-full bg-black">
      ...
      <div class="top-controls absolute top-4 right-4 flex space-x-2 z-[30]">
        ${isIPhone ? `
        <button class="quality-toggle-btn bg-black bg-opacity-50 hover:bg-opacity-70 text-text-primary p-2 rounded-full transition-opacity duration-300 opacity-0 w-8 h-8 flex items-center justify-center">
      ...
      <div class="video-preview hidden opacity-0 absolute bg-black/50 rounded-lg backdrop-blur-[2px] shadow-lg z-[30] transition-opacity duration-300 pointer-events-none" style="width: 160px; height: 90px; transform: translateX(-50%) translateY(-100%) translateY(-10px); bottom: 50px;">
        ...
        <div class="preview-time text-text-primary w-full text-xs text-center -mt-5"></div>
      </div>
        ...
        <div class="w-full">
          ...
          <div class="flex flex-row items-center justify-between mx-4">
            <div class="flex flex-row items-center gap-1">
              ...
              <div class="time-display text-text-primary text-lg font-normal cursor-pointer select-none min-w-[40px] !ml-3" style="font-family: 'DM Sans';">
            ...
            <div class="flex flex-row items-center gap-1">
              ...
              <div class="subtitle-selector relative">
                <button class="subtitle-btn text-text-primary transition text-3xl mr-2">
              ...
              <button class="download-btn text-text-primary transition h-8 w-8 mr-2" title="Download">
                <i class="icon-download text-[1.6rem]"></i>
              </button>
              
              <button class="pip-btn text-text-primary transition text-3xl mr-2 p-[0.45rem]" title="Picture in Picture">
              ...
              <button class="fullscreen-btn text-text-primary transition text-2xl">
