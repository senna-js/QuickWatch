    ...
    <div class="pb-32 md:pb-64">
      ...
      <div class="bg-[#00050d]">
        <div class="mt-12 md:mt-24">
          <h2 class="text-xl md:text-2xl text-white mb-4 ml-4 md:ml-[4.4rem] font-medium">Action Movies</h2>
          <div class="movie-carousel flex flex-row gap-4 overflow-x-auto pb-4 pl-4" data-category="action"></div>
        </div>
        
        <div class="mt-6">
          <h2 class="text-xl md:text-2xl text-white mb-4 ml-4 md:ml-[4.4rem] font-medium">Comedy Movies</h2>
          <div class="movie-carousel flex flex-row gap-4 overflow-x-auto pb-4 pl-4" data-category="comedy"></div>
        </div>
        
        <div class="mt-6">
          <h2 class="text-xl md:text-2xl text-white mb-4 ml-4 md:ml-[4.4rem] font-medium">Drama Movies</h2>
          <div class="movie-carousel flex flex-row gap-4 overflow-x-auto pb-4 pl-4" data-category="drama"></div>
        </div>
        
        <div class="mt-6">
          <h2 class="text-xl md:text-2xl text-white mb-4 ml-4 md:ml-[4.4rem] font-medium">Sci-Fi Movies</h2>
          <div class="movie-carousel flex flex-row gap-4 overflow-x-auto pb-4 pl-4" data-category="sci-fi"></div>
        </div>
        
        <div class="mt-6">
          <h2 class="text-xl md:text-2xl text-white mb-4 ml-4 md:ml-[4.4rem] font-medium">Horror Movies</h2>
          <div class="movie-carousel flex flex-row gap-4 overflow-x-auto pb-4 pl-4" data-category="horror"></div>
        </div>
        
        <div class="mt-6">
          <h2 class="text-xl md:text-2xl text-white mb-4 ml-4 md:ml-[4.4rem] font-medium">Animation Movies</h2>
